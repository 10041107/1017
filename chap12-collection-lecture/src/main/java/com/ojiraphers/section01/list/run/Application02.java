...
import main.java.com.ojiraphers.section01.list.comparator.AscendingPrice;
...
public class Application02 {
    public static void main(String[] args) {
        ...
        bookList.add(new BookDTO(2,"목민심서","정약용",20000));
        ...
        //Comparator구현체를 구현하지 않아서 실행이 안됨
        /*
        Comparator인터페이스를 상속받아 정렬의 기준을 정해준 뒤 list의 default 메소드인 sort() 메소드의 인자를
        정렬 기준이 되는 인스턴스를 넣어주게 되면 내부적으로 우리가 오버라이딩하나 메소드가 동작하게 되며
        그것을 정렬 기준으로 삼는다.
         */
...
//        });
        ...
        System.out.println("책제목을 기준으로 내림차순 정렬=========");
